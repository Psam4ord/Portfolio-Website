...
const Contact = () => {
  return (
    <div className=' flex flex-col items-center'> 
      <NavBar />
      <div className=' flex flex-col items-center xsm:w-4/5  xsm:mt-24 font-semibold bg-bgPrimary m-2 rounded-md 
      p-2'> 
      ...
      <div className=' xsm:w-4/5 font-semibold bg-bgPrimary m-2 rounded-md mt-4 p-2' >
